                ...
                else if(userInput.Equals("2"))
                {
                    ...
                    while(transaction == true)
                    {
                        ...
                        else if (userInput.Equals("2"))
                        {
                            ...
                            if(userSelectionInput.Length == 2)
                            {
                                inv.SelectProduct(userSelectionInput, userMoney, fullPath);
                            }
                            if(Int32.TryParse(userSelectionInput.Substring(3,userSelectionInput.Length-3),out int result))
                            {
                                inv.SelectProduct(userSelectionInput, userMoney, fullPath, Int32.Parse(userSelectionInput.Substring(3, userSelectionInput.Length - 3)));
                            }
